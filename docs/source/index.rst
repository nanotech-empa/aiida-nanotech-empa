...
The aiida-nanotech-empa plugin for `AiiDA`_
=====================================================

``aiida-nanotech-empa`` is available at http://github.com/yakutovicha/aiida-nanotech-empa
...
.. toctree::
   ...
   API documentation <apidoc/aiida_nanotech_empa>
...
``aiida-nanotech-empa`` is released under the MIT license. 
