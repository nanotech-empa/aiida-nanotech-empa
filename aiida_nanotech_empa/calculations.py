"""
Calculations provided by aiida_nanotech_empa.
...
class DiffCalculation(CalcJob):
    ...
    def define(cls, spec):
        ...
        spec.inputs['metadata']['options']['parser_name'].default = 'nanotech_empa'
        ...
        spec.output('nanotech_empa', valid_type=SinglefileData, help='diff between file1 and file2.')
