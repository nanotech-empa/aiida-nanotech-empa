...
from aiida_nanotech_empa.cp2k.utils.utils import get_kinds_section, tags_and_magnetization, dict_merge
...
class Cp2kMoleculeOptWorkChain(WorkChain):
    ...
    def define(cls, spec):
        ...
        spec.input(
            ...
            default=lambda:SinglefileData(file=os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "files", "BASIS_DEFAULT")),
            required=False,
        )
#        spec.input(
#            "pseudo_file",
#            valid_type=SinglefileData,            
#            default=lambda:SinglefileData(file=os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "files", "POTENTIALS_DEFAULT")),
#            required=False,
#        )        
#        
#        spec.input(
...
#            valid_type=Str,
#            default=lambda:Str('molecule workchain calc without description'),
#            required=False
#        )         
    ...
    def submit_calc(self):
        ...
        builder.cp2k.file = {
            'basis': SinglefileData(file=os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "files", "BASIS_DEFAULT")),
            'pseudo': SinglefileData(file=os.path.join(os.path.dirname(os.path.realpath(__file__)), "..", "files", "POTENTIALS_DEFAULT")),
        }
