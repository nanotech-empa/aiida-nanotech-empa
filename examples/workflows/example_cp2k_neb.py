...
def _example_cp2k_neb(cp2k_code,uks,restart_uuid):
    ...
    # check if ini rep and fin are already in database
    qb = QueryBuilder()
    ...
    sys_params={}
    sys_params['constraints'] = 'fixed xyz 1 , collective 1 [ev/angstrom^2] 40 [angstrom] 1.36'
    sys_params['colvars'] = 'distance atoms 2 3'
    neb_params = {'align_frames': '.TRUE.' ,
                  'band_type': 'CI-NEB',
                  'k_spring': 0.1,
                  'nproc_rep': 1,
                  'number_of_replica': 3,
