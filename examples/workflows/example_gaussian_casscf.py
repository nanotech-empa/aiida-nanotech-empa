...
from aiida.orm import StructureData, List, Str, Bool, Dict
from aiida.orm import load_code
from aiida.engine import run_get_node
from aiida.plugins import WorkflowFactory

GaussianCasscfSeriesWorkChain = WorkflowFactory(
...
def _example_gaussian_casscf(gaussian_code, formchk_code, cubegen_code):
    ...
    builder.nm_list = List(list=[(4, 4), (6, 6)])
    builder.multiplicity_list = List(list=[1, 3])
    ...
    for nm in [(4, 4), (6, 6)]:
        ...
        casscf_ts = (wc_node.outputs[m3_label]['casscf_energy_ev'] -
                     wc_node.outputs[m1_label]['casscf_energy_ev'])

        casmp2_ts = (wc_node.outputs[m3_label]['casmp2_energy_ev'] -
...
if __name__ == '__main__':
    _example_gaussian_casscf(load_code("gaussian@localhost"),
